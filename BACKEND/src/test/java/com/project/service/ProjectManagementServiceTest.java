...
public class ProjectManagementServiceTest {
    ...
    public void testGetProjectByIdForStudentAuthorized() {
        ...
        when(projectRepository.findByIdAndStudentIdsContaining(1L, "2")).thenReturn(Optional.of(project));

        Project result = projectService.getProjectById("1", "2", "STUDENT");
    ...
    public void testUpdateProject() {
        ...
        Project result = projectService.updateProject("1", "100", "TEACHER", update);
    ...
    public void testDeleteProject() {
        ...
        projectService.deleteProject("1", "100", "TEACHER");
